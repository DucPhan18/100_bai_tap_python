...
def baitap4():
    print(
        "Đề bài: Nhập vào một số nguyên a, nếu a chia hết cho 2 thì in ra True, ngược lại in ra False\n"
    )
    a = int(input("Nhập a : "))
    if a % 2 == 0:
        print("True")
...
def baitap5():
    print(
        "Đề bài: Nhập vào số nguyên a, nếu a là số chia hết cho 3 và nằm trong khoảng từ 50 - 100 thì in ra True, ngược lại in ra False\n"
    )
    a = int(input("Nhập a : "))
...
def baitap6():
    print(
        "Đề bài: Nhập vào số nguyên a, nếu a là số chia hết cho 5 nhưng KHÔNG nằm trong khoảng từ 20 - 70 thì in ra True, ngược lại in ra False\n"
    )
    a = int(input("Nhập a : "))
...
def baitap7():
    print(
        "Đề bài: Nhập vào nguyên a và b, nếu 1 trong 2 số a và b chia hết cho 2 thì in ra True, ngược lại in ra False\n"
    )
    a = int(input("Nhập a : "))
    b = int(input("Nhâp b : "))
    if a % 2 == 0 or b % 2 == 0:
...
def baitap8():
    print(
        "Đề bài: Nhập vào số thực a, kiểm tra xem a có phải là số nguyên hay không, nếu có thì in ra True, ngược lại in ra False\n"
    )
...
def baitap9():
    print(
        "Đề bài: Nhập vào số nguyên a, kiểm tra xem a có phải là số chính phương hay không, nếu có thì in ra True, ngược lại in ra False\n"
    )
    a = float(input("Nhập a : "))
    a = math.sqrt(a)
    check = round(a)
...
def baitap10():
    print(
        "Đề bài: Nhập vào lương tháng này nhận được, ta phải đưa cho vợ 90% số tiền lương đó. Hãy in ra lương ta giữ lại\n"
    )
...
def baitap13():
    print(
        "Đề bài: Nhập vào số nguyên dương a, nếu a lớn hơn 10 thì ta in ra đây là số lớn hơn 10\n"
    )
    a = int(input("Nhập a : "))
    if a > 10:
...
def baitap14():
    print(
        "Đề bài: Nhập vào số nguyên dương a, nếu a là số chẵn thì in ra đây là số chẵn, ngược lại in ra đây là số lẻ\n"
    )
    a = int(input("Nhập a : "))
    if a % 2 == 0:
...
def baitap15():
    print(
        "Đề bài: Nhập vào 3 số thực dương a, b, c. Kiểm tra xem a, b, c có cấu thành độ dài của 1 tam giác được không\n"
    )
...
def baitap16():
    print(
        "Đề bài: Từ bài số 15, nếu a, b, c cấu tạo thành được một tam giác, kiểm tra xem đó là tam giác gì (tam giác đều, tam giác vuông cân, tam giác vuông, tam giác cân hay tam giác thường)\n"
    )
    print("Nếu nhập số âm chương trình sẽ tự động lấy trị tuyệt đối của số đó")
    a = int(input("Nhập cạnh a : "))
    b = int(input("Nhập cạnh b : "))
...
def baitap17():
    print(
        "Đề bài: Nhập vào 3 số a, b, c. Hãy sắp xếp 3 số a, b, c theo thứ tự tăng dần rồi in ra lại\n"
    )
